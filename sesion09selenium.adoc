...
. Elegid una de las plantillas. Si deseais usar alguna otra plantilla en otra tecnología, comentádmelo antes por si implementa la funcionalidad básica requerida.
...
- Editar el perfil de usuario (caso correcto)
- Editar el perfil de usuario (casos incorrectos)
- Cambio de contraseña de usuario (Caso correcto)
- Cambio de contraseña de usuario (Casos incorrectos)
...
If you're using Maven, you will find more information https://www.selenium.dev/maven[here].
