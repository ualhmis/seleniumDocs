...
.Asistente para despliegue en Azure
image::azure-webapp-config.png[role="thumb", align="center", width=60%]
...
CRUD sobre una entidad (por ejemplo, tareas, usuarios, eventos, etc.):
    ...
    - Eliminación  (caso correcto)  (_en caso de que la plantilla lo permita_)
    - Eliminación  (casos incorrectos)  (_en caso de que la plantilla lo permita_)
****
[NOTE]
====
