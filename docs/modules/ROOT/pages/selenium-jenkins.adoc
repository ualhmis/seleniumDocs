...
wget https://storage.googleapis.com/chrome-for-testing-public/148.0.7778.97/linux64/chromedriver-linux64.zip <4>
sudo apt-get install unzip -y 
sudo unzip chromedriver-linux64.zip -d $JENKINS_HOME/selenium-drivers/ <5>
...
Debería funcionar sin errores, y mostarr la versión de Firefox instalada. Si no es así, revisa los pasos anteriores.
