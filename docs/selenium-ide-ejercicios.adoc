...
[NOTE]
====
Los mensajes de validación son distintos en cada navegador, tenlo en cuenta a la hora de definir el `assert`. También hay que considerar el idioma en el que esté configurado el navegador. 

.Validación de email incorrecto en Firefox y Chrome
|===

a| image::https://blog.mozilla.org/firefox/files/2017/12/firefox-logo-600x619.png[role="thumb", align="center", width=10%]  a| image::https://www.google.com/chrome/static/images/chrome-logo.svg[role="thumb", align="center", width=60%]

a| image::selenium-ide-email-incorrecto-firefox.png[role="thumb", align="center"] a| image::selenium-ide-email-incorrecto-chrome.png[role="thumb", align="center"]
