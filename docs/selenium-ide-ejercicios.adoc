...
Como acabamos de ver en el punto anterior, puede ser necesario que en función del navegador que estemos usando o el idioma en el que esté configurado el navegador, nuestro assert deba validar un mensaje de texto u otro.
...
image::selenium-ide-conditional-navigators.png[role="thumb", align="center", width=70%]
